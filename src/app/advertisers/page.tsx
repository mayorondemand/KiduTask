...
const mockQuickStats = [
  ...
  { label: "Avg. Completion Time", value: "3.2h", change: "-15%", trend: "down" },
...
export default function AdvertiserDashboard() {
  ...
  const growthPercentage = (
    ((mockStats.thisMonthSpent - mockStats.lastMonthSpent) / mockStats.lastMonthSpent) *
    100
  ).toFixed(1)
          ...
          <div className="mb-6 lg:mb-0">
            <div className="flex items-center gap-4 mb-3">
              ...
              <div>
                ...
                <p className="text-gray-600 mt-1">Here's your campaign performance overview</p>
              </div>
            </div>
          </div>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <div
                    className={`flex items-center gap-1 text-xs px-2 py-1 rounded-full ${
                      stat.trend === "up" ? "bg-emerald-50 text-emerald-600" : "bg-blue-50 text-blue-600"
                    }`}
                  >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          <Card className="border-0 shadow-lg bg-gradient-to-br from-purple-500 to-purple-600 text-white">
            <CardContent className="p-6">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-purple-100 text-sm mb-1">Active Campaigns</p>
                  <p className="text-3xl font-bold">{mockStats.activeCampaigns}</p>
                  <p className="text-purple-100 text-xs mt-1">{mockStats.pendingApprovals} pending approval</p>
                </div>
            ...
            <CardContent className="p-6">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-3xl font-bold">{formatCurrency(mockStats.totalSpent)}</p>
                  <p className="text-emerald-100 text-xs mt-1">+{growthPercentage}% this month</p>
                </div>
                <div className="p-3 rounded-full bg-white/20">
            ...
            <CardContent className="p-6">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-3xl font-bold">{mockStats.totalReach.toLocaleString()}</p>
                  <p className="text-blue-100 text-xs mt-1">Unique users reached</p>
                </div>
                <div className="p-3 rounded-full bg-white/20">
            ...
            <CardContent className="p-6">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-3xl font-bold">{mockStats.approvalRate}%</p>
                  <p className="text-orange-100 text-xs mt-1">Campaign approval rate</p>
                </div>
                <div className="p-3 rounded-full bg-white/20">
            ...
            <CardContent className="space-y-3">
              <Link href="/advertisers/campaign/new">
                ...
                >
                  ...
                  <div className="text-left">
                    ...
                    <div className="text-xs text-gray-500">Launch a new task campaign</div>
                  </div>
                </Button>
              </Link>
              ...
              <Link href="/advertisers/campaigns">
                ...
                >
                  ...
                  <div className="text-left">
                    ...
                    <div className="text-xs text-gray-500">Manage existing campaigns</div>
                  </div>
                </Button>
              </Link>
              ...
              <Link href="/advertisers/brand">
                ...
                >
                  ...
                  <div className="text-left">
                    <div className="font-medium text-gray-900">Brand Settings</div>
                    <div className="text-xs text-gray-500">Update brand information</div>
                  </div>
                </Button>
              </Link>
            </CardContent>
            ...
            <CardContent>
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                <div className="text-center p-4 bg-gradient-to-br from-purple-50 to-purple-100 rounded-xl">
                  <div className="text-2xl font-bold text-purple-600">{mockStats.totalCampaigns}</div>
                  <div className="text-sm text-purple-700 mt-1">Total Campaigns</div>
                </div>
                <div className="text-center p-4 bg-gradient-to-br from-emerald-50 to-emerald-100 rounded-xl">
                  <div className="text-2xl font-bold text-emerald-600">{mockStats.approvalRate}%</div>
                  <div className="text-sm text-emerald-700 mt-1">Approval Rate</div>
                </div>
                <div className="text-center p-4 bg-gradient-to-br from-blue-50 to-blue-100 rounded-xl">
                  <div className="text-2xl font-bold text-blue-600">{formatCurrency(mockStats.avgCostPerTask)}</div>
                  <div className="text-sm text-blue-700 mt-1">Avg Cost/Task</div>
                </div>
                <div className="text-center p-4 bg-gradient-to-br from-orange-50 to-orange-100 rounded-xl">
                  <div className="text-2xl font-bold text-orange-600">{mockStats.conversionRate}%</div>
                  <div className="text-sm text-orange-700 mt-1">Conversion Rate</div>
                </div>
              </div>
            </CardContent>
          </Card>
        ...
        <Card className="border-0 shadow-lg bg-white">
          <CardHeader className="flex flex-row items-center justify-between pb-4">
            <div>
              ...
              <CardDescription>Your latest campaign activity and performance</CardDescription>
            </div>
            <Link href="/advertisers/campaigns">
