...
const mockSubmissions = [
  {
    ...
    proofText: "Followed @kuditask_official and liked the latest 3 posts as requested.",
    feedback: "",
    rating: 0,
  },
  {
  ...
  },
  {
    ...
    feedback: "Please make sure to like the 3 most recent posts as specified in the instructions.",
    rating: 2,
  },
]
...
export default function CampaignDetailsPage({ params }: { params: { id: string } }) {
  ...
  const handleSubmissionAction = async () => {
    ...
    try {
      ...
      toast({
        title: reviewDecision === "approve" ? "Submission Approved" : "Submission Rejected",
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="flex items-center gap-4 mb-8">
          ...
          <div className="flex-1">
            ...
            <p className="text-muted-foreground">
              Created {new Date(campaign.createdAt).toLocaleDateString()} • Expires{" "}
          ...
          <div className="flex gap-2">
            ...
            <Button variant="outline" onClick={toggleCampaignStatus} className="flex items-center gap-2 bg-transparent">
                ...
                <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                    <div className="text-center">
                      <div className="text-2xl font-bold text-green-600">{campaign.approvedSubmissions}</div>
                      <div className="text-sm text-muted-foreground">Approved</div>
                    </div>
                    <div className="text-center">
                      <div className="text-2xl font-bold text-yellow-600">{campaign.pendingSubmissions}</div>
                      <div className="text-sm text-muted-foreground">Pending</div>
                    </div>
                    <div className="text-center">
                      <div className="text-2xl font-bold text-red-600">{campaign.rejectedSubmissions}</div>
                      <div className="text-sm text-muted-foreground">Rejected</div>
                    </div>
                    <div className="text-center">
                      <div className="text-2xl font-bold">{campaign.currentSubmissions}</div>
              ...
              <CardContent className="space-y-4">
                ...
                <div className="space-y-3 pt-4">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <span className="font-medium">{formatCurrency(campaign.totalSpent)}</span>
                  </div>
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <span className="font-medium">{campaign.estimatedTimeMinutes}min</span>
                  </div>
        ...
        <Tabs defaultValue="submissions" className="space-y-6">
          <TabsList>
            <TabsTrigger value="submissions">Submissions ({campaign.currentSubmissions})</TabsTrigger>
            ...
            <Card>
              <CardHeader className="flex flex-row items-center justify-between">
                <div>
                  ...
                  <CardDescription>Review and manage all task submissions</CardDescription>
                </div>
                <Button variant="outline" size="sm">
                  ...
                  {submissions.map((submission) => (
                    <div key={submission.id} className="flex items-start gap-4 p-4 border rounded-lg">
                      ...
                      <div className="flex-1">
                        ...
                        <p className="text-sm text-muted-foreground mb-2">{submission.proofText}</p>
                        ...
                        {submission.status !== "pending" && submission.rating > 0 && (
                          <div className="flex items-center gap-2">
                            <span className="text-sm font-medium">Rating:</span>
                            {renderStarRating(submission.rating, undefined, true)}
                          </div>
                        )}
                      </div>
                          ...
                          <Dialog>
                            ...
                            <DialogContent className="max-w-2xl">
                              <DialogHeader>
                                ...
                                <DialogDescription>
                                  Review {submission.userName}'s submission and provide your decision
                                </DialogDescription>
                              </DialogHeader>
                              ...
                              <div className="space-y-6">
                                <div>
                                  ...
                                  <p className="text-sm text-muted-foreground mt-1">{submission.proofText}</p>
                                </div>
                                ...
                                <div>
                                  ...
                                  >
                                    <div className="flex items-center space-x-2">
                                      ...
                                      <Label htmlFor="approve" className="text-green-600 font-medium">
                                        Approve Submission
                                      </Label>
                                    </div>
                                    <div className="flex items-center space-x-2">
                                ...
                                {reviewDecision === "approve" && (
                                  <div>
                                    ...
                                    <div className="mt-2">{renderStarRating(rating, setRating)}</div>
                                  </div>
                                )}

                                <div>
                                  <Label htmlFor="feedback">
                                    Feedback {reviewDecision === "reject" ? "*" : "(Optional)"}
                                  </Label>
                                  <Textarea
                                    id="feedback"
                                    placeholder={
                                  ...
                                  {reviewDecision === "reject" && (
                                    <p className="text-sm text-muted-foreground mt-1">
                                      Feedback is required when rejecting submissions
                                    </p>
                                  )}
                                </div>
                              </div>
          ...
          <TabsContent value="instructions">
            <Card>
              <CardHeader>
                ...
                <CardDescription>The instructions provided to taskers for this campaign</CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                <div>
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    ...
                    <p className="text-2xl font-bold text-green-600">{formatCurrency(campaign.payoutPerUser)}</p>
                  </div>
                  <div>
                    <h3 className="font-medium mb-2">Estimated Time</h3>
                    <p className="text-2xl font-bold">{campaign.estimatedTimeMinutes} minutes</p>
                  </div>
                </div>
              </CardContent>
            </Card>
                  ...
                  {campaignHistory.map((historyItem, index) => (
                    <div key={historyItem.id} className="flex gap-4">
                      <div className="flex flex-col items-center">
                        ...
                        {index < campaignHistory.length - 1 && <div className="w-px h-12 bg-border mt-2" />}
                      </div>
                      ...
                      <div className="flex-1 pb-8">
                        ...
                        <div className="bg-muted p-3 rounded-lg">
                          <div className="flex items-center justify-between">
                            <span className="text-sm font-medium">By: {historyItem.user}</span>
                          </div>
                          <p className="text-sm text-muted-foreground mt-1">{historyItem.details}</p>
                        </div>
                      </div>
                    </div>
                  ))}
          ...
          <TabsContent value="analytics">
            <Card>
              <CardHeader>
                ...
                <CardDescription>Performance insights and metrics for your campaign</CardDescription>
              </CardHeader>
              <CardContent>
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
                  <div className="text-center p-4 border rounded-lg">
                    <div className="text-2xl font-bold text-blue-600">
                      {((campaign.approvedSubmissions / campaign.currentSubmissions) * 100).toFixed(1)}%
                    </div>
                    <div className="text-sm text-muted-foreground">Approval Rate</div>
                  </div>
                  <div className="text-center p-4 border rounded-lg">
                    <div className="text-2xl font-bold text-green-600">
                      {formatCurrency(campaign.totalSpent / campaign.approvedSubmissions)}
                    </div>
                    <div className="text-sm text-muted-foreground">Cost per Approval</div>
                  </div>
                  <div className="text-center p-4 border rounded-lg">
                    <div className="text-2xl font-bold text-purple-600">
                      {Math.round((Date.now() - new Date(campaign.createdAt).getTime()) / (1000 * 60 * 60 * 24))}
                    </div>
                    ...
                    <div className="text-2xl font-bold text-orange-600">
                      {Math.round(
                        campaign.currentSubmissions /
                          Math.max(1, (Date.now() - new Date(campaign.createdAt).getTime()) / (1000 * 60 * 60 * 24)),
                      )}
                    </div>
                    <div className="text-sm text-muted-foreground">Submissions/Day</div>
                  </div>
                </div>
