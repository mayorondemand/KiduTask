...
import { ArrowLeft, Upload, DollarSign, Users, Clock, Calculator, Eye, AlertCircle, Plus, X, Save } from "lucide-react"
...
export default function EditCampaignPage({ params }: { params: { id: string } }) {
  ...
  const currentBannerUrl = formData.bannerImage ? URL.createObjectURL(formData.bannerImage) : formData.currentBannerUrl
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="flex items-center gap-4 mb-8">
          ...
          <div>
            ...
            <p className="text-muted-foreground mt-1">Update your campaign details and settings</p>
          </div>
        </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>Update the essential details about your campaign</CardDescription>
                </CardHeader>
              ...
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>Update the requirements and instructions for taskers</CardDescription>
                </CardHeader>
                <CardContent className="space-y-4">
                  <div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                      ...
                      <Input
                        ...
                        onChange={(e) =>
                          handleInputChange("estimatedTimeMinutes", Number.parseInt(e.target.value) || 0)
                        }
                      />
                    </div>
                    <div>
              ...
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>Update your budget and target audience size</CardDescription>
                </CardHeader>
                <CardContent className="space-y-4">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
              ...
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>Update your campaign banner image</CardDescription>
                </CardHeader>
                <CardContent>
                  <div
                      ...
                      <div className="space-y-4">
                        ...
                        <div className="flex items-center justify-center gap-2">
                          <span className="text-sm text-muted-foreground">
                            {formData.bannerImage ? formData.bannerImage.name : "Current banner"}
                          </span>
                          <Button
                            type="button"
                            variant="outline"
            ...
            <div className="sticky top-8">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>How your updated campaign will appear</CardDescription>
                </CardHeader>
                <CardContent className="space-y-4">
                  {currentBannerUrl && (
                    <img
