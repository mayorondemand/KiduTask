      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold">{stats.totalAdvertisers.toLocaleString()}</div>
              <p className="text-xs text-muted-foreground">
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              ...
              <div className="flex items-center justify-between">
                ...
                <Badge className="bg-green-100 text-green-800 hover:bg-green-100">{stats.activeCampaigns}</Badge>
              </div>
              <div className="flex items-center justify-between">
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <div className="flex items-center justify-between">
                ...
                <Badge className="bg-orange-100 text-orange-800 hover:bg-orange-100">{stats.pendingPayouts}</Badge>
              </div>
              <div className="flex items-center justify-between">
                <span className="text-sm text-muted-foreground">Pending Amount</span>
                <span className="font-semibold">{formatCurrency(stats.pendingPayoutAmount)}</span>
              </div>
              <div className="flex items-center justify-between">
