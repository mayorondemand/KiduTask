...
export default function SettingsPage() {
  ...
  const bankMutation = useMutation({
    ...
    onSuccess: () => {
      toast({
        ...
        description:
          "Your bank account details have been updated and are being verified.",
      });
      queryClient.invalidateQueries({ queryKey: ["settings"] });
    },
    onError: () => {
      toast({
        title: "Update Failed",
        description:
          "There was an error updating your bank account. Please try again.",
        variant: "destructive",
      });
    },
  });
  ...
  const kycMutation = useMutation({
    ...
    onSuccess: () => {
      toast({
        title: "KYC Submitted",
        description:
          "Your KYC information has been submitted for review. You'll be notified once approved.",
      });
      queryClient.invalidateQueries({ queryKey: ["settings"] });
    },
    onError: () => {
  ...
  const securityMutation = useMutation({
    mutationFn: ({ setting, value }: { setting: string; value: any }) =>
    ...
    onError: () => {
      toast({
        title: "Update Failed",
        description:
          "There was an error updating your security setting. Please try again.",
        variant: "destructive",
      });
    },
  });
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="mb-8">
            ...
            <p className="text-gray-600">
              Manage your profile, security, and banking information
            </p>
          </div>
                ...
                <CardContent className="space-y-4">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <Select
                      ...
                      onValueChange={(value) =>
                        updateSecurity("sessionTimeout", Number.parseInt(value))
                      }
                    >
            ...
            <TabsContent value="banking" className="space-y-6">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Add your bank account for withdrawals. Account will be
                ...
                <CardContent>
                  ...
                  >
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div className="space-y-2">
                        ...
                        <Input
                          ...
                          defaultValue={
                            settings?.banking.bankAccount?.accountName
                          }
                        />
                        {bankErrors.accountName && (
                          <p className="text-sm text-destructive">
                            {bankErrors.accountName.message}
                          </p>
                        )}
                      </div>
                      ...
                      <div className="space-y-2">
                        ...
                        <Input
                          ...
                          defaultValue={
                            settings?.banking.bankAccount?.accountNumber
                          }
                        />
                    ...
                    <Alert>
                      ...
                      <AlertDescription>
                        Your bank account will be verified through Flutterwave
              ...
              <Card>
                <CardHeader>
                  <CardTitle className="flex items-center justify-between">
                    ...
                    {getKYCStatusBadge(
                      settings?.banking.kycStatus || "not_started",
                    )}
                  </CardTitle>
                  <CardDescription>
                ...
                <CardContent>
                    ...
                    >
                      ...
                      <Alert>
                        ...
                        <AlertDescription>
                          ...
                          use this information only for identity verification as
                  ...
                  {settings?.banking.kycData?.documents &&
                    settings.banking.kycData.documents.length > 0 && (
                      <div className="mt-6">
                        <h4 className="font-medium mb-4">Uploaded Documents</h4>
                        <div className="space-y-3">
                          {settings.banking.kycData.documents.map(
                            (doc, index) => (
                              <div
                                key={index}
                                className="flex items-center justify-between p-3 border rounded-lg"
