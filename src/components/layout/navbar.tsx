    ...
    if (user.role === "admin") {
      return (
        <>
          ...
          <Link href="/admin/campaigns" className="text-sm font-medium hover:text-primary">
            Campaigns
          </Link>
              ...
              <Dialog open={advertiserDialogOpen} onOpenChange={setAdvertiserDialogOpen}>
                ...
                <DialogContent className="sm:max-w-md">
                  <DialogHeader>
                    ...
                    <DialogDescription>
                      Unlock powerful tools to grow your business and reach thousands of potential customers.
                    </DialogDescription>
                  </DialogHeader>
                    ...
                    <div className="space-y-4">
                      <div className="grid grid-cols-2 gap-3">
                        <div className="bg-gradient-to-br from-blue-50 to-blue-100 p-4 rounded-lg text-center">
                          ...
                          <div className="text-sm font-medium text-blue-900">Instant Reach</div>
                          <div className="text-xs text-blue-700">Access 10k+ active users</div>
                        </div>
                        ...
                        <div className="bg-gradient-to-br from-green-50 to-green-100 p-4 rounded-lg text-center">
                          ...
                          <div className="text-sm font-medium text-green-900">Real Analytics</div>
                          <div className="text-xs text-green-700">Track every campaign</div>
                        </div>
                      </div>
                      ...
                      <div className="grid grid-cols-2 gap-3">
                        <div className="bg-gradient-to-br from-purple-50 to-purple-100 p-4 rounded-lg text-center">
                          ...
                          <div className="text-sm font-medium text-purple-900">Quality Users</div>
                          <div className="text-xs text-purple-700">KYC verified taskers</div>
                        </div>
                        ...
                        <div className="bg-gradient-to-br from-orange-50 to-orange-100 p-4 rounded-lg text-center">
                          ...
                          <div className="text-sm font-medium text-orange-900">Easy Setup</div>
                          <div className="text-xs text-orange-700">Launch in minutes</div>
                        </div>
                      </div>

                      <div className="bg-gradient-to-r from-purple-600 to-blue-600 p-4 rounded-lg text-white text-center">
                        <div className="text-lg font-bold">🚀 Start Growing Today</div>
                        <div className="text-sm opacity-90">Join 500+ businesses already using KudiTask</div>
                      </div>
                    </div>
                  </div>
